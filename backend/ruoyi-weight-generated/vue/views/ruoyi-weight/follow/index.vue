<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="followList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关注者用户ID" align="center" prop="followerId" />
      <el-table-column label="被关注者用户ID" align="center" prop="followingId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="关注者用户ID" prop="followerId">
          <el-input v-model="form.followerId" placeholder="请输入关注者用户ID" />
        </el-form-item>
        <el-form-item label="被关注者用户ID" prop="followingId">
          <el-input v-model="form.followingId" placeholder="请输入被关注者用户ID" />
        </el-form-item>
      </el-form>
...
<script>
import { listFollow, getFollow, delFollow, addFollow, updateFollow } from "@/api/ruoyi-weight/follow"
