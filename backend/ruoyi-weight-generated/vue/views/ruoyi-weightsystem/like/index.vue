    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['ruoyi-weightsystem:like:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['ruoyi-weightsystem:like:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ruoyi-weightsystem:like:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ruoyi-weightsystem:like:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listLike, getLike, delLike, addLike, updateLike } from "@/api/ruoyi-weightsystem/like"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除动态点赞编号为"' + ids + '"的数据项？').then(function() {
        return delLike(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ruoyi-weightsystem/like/export', {
        ...this.queryParams
